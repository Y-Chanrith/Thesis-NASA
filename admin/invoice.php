<?php 
 ...
 // include ("../connection.php");
  ...
  $info=[
    ...
    "total_amt"=>"5200.00",
    "words"=>"Five Thousand Two Hundred Only",
  ];
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"NASA COMPUTER",0,1);
      $this->SetFont('Arial','',12);
      $this->Cell(50,7,"Kondal Street,",0,1);
      $this->Cell(50,7,"Siem Reap, Cambodia.",0,1);
      $this->Cell(50,7,"Phone : 097 87 17 700",0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"NASA COMPUTER",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
